...
/**
* Interface describing `dmskmidrange`.
*/
interface Routine {
	/**
	...
	*/
	...
	/**
	* Computes the mid-range of a double-precision floating-point strided array according to a mask and using alternative indexing semantics.
	*
	* @param N - number of indexed elements
	* @param x - input array
	* @param strideX - `x` stride length
...
* // returns 0.0
*/
declare var dmskmidrange: Routine;
